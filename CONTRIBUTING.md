...
pip install shellcheck-py ruff mypy types-PyYAML hadolint-coatl google-yamlfmt yamllint pytest pyyaml
```
...
```bash
make lint   # shfmt + shellcheck + ruff + mypy --strict + dockerfmt + hadolint + yamlfmt + yamllint
